...
const ItemCard = ({ item, index }) => {
  return (
    <Card className="flex items-center justify-between w-full h-48 gap-5 px-4 py-12 shadow-lg 2xl:min-w-96 2xl:px-8">
      <div className="flex items-center w-full h-full gap-4">
        ...
        <div className="space-y-3">
          ...
          <span className="text-xs text-gray-600 dark:text-gray-400 md:text-sm 2xl:text-base dark:text-gray-500">
            Overall {item.label}
          </span>
        </div>
      </div>
